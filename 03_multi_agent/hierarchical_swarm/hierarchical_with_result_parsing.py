"""
Hierarchical Swarm With Result Parsing
======================================

Runs a hierarchical swarm and walks the response structure, printing each
agent's contribution separately instead of dumping raw JSON.

Run:
    python hierarchical_with_result_parsing.py
...
def main():
    """Run a simple hierarchical swarm."""
    payload = {
    ...
    print("Hierarchical Swarm Response:")
