"""
Concurrent Workflow With Tools
==============================

Runs every agent in the swarm at the same time against the same task, with
tools enabled. Fastest swarm type when the agents do not need each other's
output.

Run:
    python concurrent_workflow_with_tools.py
