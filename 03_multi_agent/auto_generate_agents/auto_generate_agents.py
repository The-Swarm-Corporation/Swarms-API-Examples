...
Describes a goal and lets `POST /v1/agents/auto-generate` design the agent team
for you, instead of hand-writing every system prompt.

Run:
    python auto_generate_agents.py
