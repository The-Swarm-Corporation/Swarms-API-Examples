# Agent Completions API Reference
...
| `model_name` | `string` | No | `"gpt-4.1"` | AI model to use (e.g., gpt-4o, gpt-4.1, claude-3-5-sonnet) |
...
- **OpenAI Models**: gpt-4o, gpt-4.1, gpt-4.1
...
payload = {
    "agent_config": {
        ...
        "description": "Expert in analyzing and describing images",
...
# Execute task
result = agent.run("Explain quantum mechanics")
```
...
- **API Documentation**: [https://docs.swarms.ai](https://docs.swarms.ai)
...
- **Community**: [https://discord.gg/swarms](https://discord.gg/swarms)
