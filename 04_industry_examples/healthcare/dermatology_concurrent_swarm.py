"""
Dermatology Concurrent Swarm
============================

Several specialists analyze the same dermatological case in parallel, then the
run's logs are pulled back for inspection.

Run:
    python dermatology_concurrent_swarm.py
