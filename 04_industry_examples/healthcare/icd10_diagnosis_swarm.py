"""
ICD-10 Diagnosis Swarm
======================

Sequential swarm that reads lab data, maps findings to ICD-10 codes and adds
clinical decision support on top.

Run:
    python icd10_diagnosis_swarm.py
