"""
Enterprise Medical Demo
=======================

A production-shaped clinical workflow with multiple specialist agents, error
handling and formatted reporting.

Run:
    python enterprise_medical_demo.py
