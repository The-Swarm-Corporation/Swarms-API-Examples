"""
Financial Swarm With Tools
==========================

Concurrent financial analysts with tool access (search and code execution) so
they can pull live data rather than reason from memory.

Run:
    python financial_swarm_with_tools.py
